...
public class GameApiServerGenerator extends AbstractPhpCodegen implements CodegenConfig {

  @SuppressWarnings("hiding")
    private final Logger LOGGER = LoggerFactory.getLogger(GameApiServerGenerator.class);
    ...
    public GameApiServerGenerator() {
        ...
        setBundleName("GameApi");
        setBundleAlias("game_api");
        modelDirName = "Model";
        docsBasePath = "docs";
        ...
        embeddedTemplateDir = templateDir = "game-api-server";
    ...
    public String getName() {
        return "game-api-server";
    }

    @Override
    public String getHelp() {
        return "Generates a PHP game-api-server server bundle.";
    }
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("serialization/DefaultDriverFactory.mustache", toSrcPath(servicePackage, srcBasePath), "DefaultDriverFactory.php"));
